...
use lox_zkp::{toolbox::{prover::Prover, verifier::Verifier, SchnorrCS, TranscriptProtocol}, Transcript};
...
fn simSC(y: &RistrettoPoint, c: &Scalar, g: &RistrettoPoint) -> (RistrettoPoint, Scalar){
